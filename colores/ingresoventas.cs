...
namespace colores
{
    class ingresoventas
    {
        ...
        public MySqlCommand Registrar_venta(int id, DateTime fecha, string horae, string placa ,int egresos, string tipo,string mes,string servicio,string cliente,string usuario, int valor)
        {
